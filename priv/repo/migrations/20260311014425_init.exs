defmodule Craftplan.Repo.Migrations.Init do
  ...
  def up do
    create table(:settings, primary_key: false) do
      ...
      add :shipping_flat, :money_with_currency, default: fragment("('EUR', 0)")
      add :labor_hourly_rate, :money_with_currency, default: fragment("('EUR', 0)")
    ...
    create table(:orders_orders, primary_key: false) do
      ...
      add :subtotal, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :tax_total, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :shipping_total, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :discount_total, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :total, :money_with_currency, null: false, default: fragment("('EUR', 0)")
    ...
    create table(:orders_items, primary_key: false) do
      ...
      add :batch_code, :text
      add :material_cost, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :labor_cost, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :overhead_cost, :money_with_currency, null: false, default: fragment("('EUR', 0)")
      add :unit_cost, :money_with_currency, null: false, default: fragment("('EUR', 0)")
    ...
    alter table(:inventory_materials) do
      modify :location_id,
             references(:inventory_locations,
               column: :id,
               name: "inventory_materials_location_id_fkey",
               type: :uuid,
               prefix: "public"
             )
    end
    ...
    create table(:catalog_labor_steps, primary_key: false) do
      ...
      add :rate_override, :money_with_currency
  ...
  def down do
    ...
    drop constraint(:inventory_materials, "inventory_materials_location_id_fkey")
