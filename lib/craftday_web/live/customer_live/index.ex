defmodule CraftdayWeb.CustomerLive.Index do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        module={CraftdayWeb.CustomerLive.FormComponent}
  ...
  def mount(_params, _session, socket) do
    {:ok,
     ...
     |> stream(
       :customers,
       Ash.read!(Craftday.CRM.Customer,
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(
      :customer,
      Craftday.CRM.get_customer_by_id!(id,
        actor: socket.assigns.current_user,
  ...
  @impl true
  def handle_info({{CraftdayWeb.CustomerLive.FormComponent, :saved, customer}}, socket) do
