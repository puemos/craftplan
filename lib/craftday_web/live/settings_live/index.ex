defmodule CraftdayWeb.SettingsLive.Index do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <.tabs id="settings-tabs">
      ...
      >
        <div class="max-w-lg">
          <.live_component
            module={CraftdayWeb.SettingsLive.FormComponent}
            id="settings-form"
      ...
      >
        <div class="">
          <.live_component
            module={CraftdayWeb.SettingsLive.AllergensComponent}
      ...
      >
        <div class="">
          <.live_component
            module={CraftdayWeb.SettingsLive.NutritionalFactsComponent}
  ...
  @impl true
  def handle_info({CraftdayWeb.SettingsLive.FormComponent, {:saved, settings}}, socket) do
