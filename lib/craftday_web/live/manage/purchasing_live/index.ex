defmodule CraftdayWeb.PurchasingLive.Index do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        module={CraftdayWeb.PurchasingLive.PurchaseOrderFormComponent}
        id="po-form"
    ...
    >
      <.live_component
        module={CraftdayWeb.PurchasingLive.PurchaseOrderItemFormComponent}
        id="po-item-form"
        current_user={@current_user}
        materials={@materials}
