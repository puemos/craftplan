defmodule CraftdayWeb.ManageOrdersItemsInteractionsLiveTest do
  use CraftdayWeb.ConnCase, async: true

  import Phoenix.LiveViewTest

  alias Craftday.Catalog.{Product, Recipe}
  alias Craftday.Inventory.Material
  alias Craftday.Orders.Order
  ...
  defp create_order_with_item!(product) do
    Order
    |> Ash.Changeset.for_create(:create, %{
      customer_id: Craftday.CRM.Customer
                   |> Ash.Changeset.for_create(:create, %{
                     type: :individual,
                     first_name: "Ada",
                     last_name: "Lovelace"
